...
I18n.registerTranslations('ge', {
    ...
    tournaments: {
        ...
        statisticsSubtitle: 'Statistics will appear after match events',
        noFixtures: 'No Fixtures Yet',
        fixturesSubtitle: 'Generate fixtures to see the match schedule!',
        teamParticipating: 'Your team is participating',
    ...
    addPlayer: {
        ...
        confirmRemove: 'Remove this player from the team?',
